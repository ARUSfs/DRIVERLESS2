...
namespace Scoring{
    ...
    */
    void scoring_surface(pcl::PointCloud<pcl::PointXYZI>::Ptr& cloud_filtered,  pcl::PointCloud<pcl::PointXYZI>::Ptr& cloud_clusters, 
        ...
        std::vector<PointXYZColorScore>& cluster_centers, double threshold)
        {
            ...
            for (size_t i = 0; i < cluster_indices.size(); ++i) 
            {
                ...
                if (average_score >= threshold) 
                {
                    ...
                    filtered_map_cloud->points.push_back(center);
                }
            }
    }
